...
const AuthAdminSchema = new mongoose_1.Schema({
    adminUserName: {
        type: String,
        required: true,
        trim: true,
...
const authAdminUserModel = mongoose_1.default.model("admin-user", AuthAdminSchema);
exports.default = authAdminUserModel;
