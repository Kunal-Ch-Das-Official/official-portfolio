...
class BlogsInfo {
    getCtrl(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (id) {
                    const findSingleBlog = yield blogCollection_1.default.findById(id);
                    if (!findSingleBlog) {
                    ...
                    const findAllBlog = yield blogCollection_1.default.find();
                    if (!findAllBlog) {
                        return res.status(404).json({
                            issue: "Not Found!",
                        ...
                        return res.status(200).json(findAllBlog);
                    }
                }
            }
            catch (error) {
