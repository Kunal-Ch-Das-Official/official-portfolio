    ...
    uploadCtrl(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (file) {
                    const cloudUpload = yield uploader.uploadSingle(resumeBuffer, "Resume");
                    if (!cloudUpload) {
                        ...
                        const resumeInfo = new resumeCollection_1.default({
                            resumeUrl: storedDataAccessUrl,
                            resumePublicId: storedDataAccessId,
                        });
                        const saveResume = yield resumeInfo.save();
                        if (!saveResume) {
                            ...
                            return res.status(201).json({
                                ...
                                details: "New resume has been successfully uploaded to our records.",
                            });
                        }
                    }
                }
