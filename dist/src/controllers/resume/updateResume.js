    ...
    updateCtrl(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let existingResume = yield resumeCollection_1.default.findById(id);
                if (!existingResume) {
                    ...
                    const uploadNewResume = yield uploader.uploadSingle(resumeBuffer, "Resume");
                    if (!uploadNewResume) {
                        ...
                        const resumeUpdate = yield resumeCollection_1.default.findByIdAndUpdate(id, updatedResume, { new: true });
                        if (!resumeUpdate) {
...
exports.default = new ExistingResume();
