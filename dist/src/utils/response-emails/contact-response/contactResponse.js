...
class ContactResponse {
    sendemail(sendTo, userName, subject, mailBody, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const transporter = nodemailer_1.default.createTransport({
                host: envConfig_1.default.emailHostProtocol,
                port: envConfig_1.default.emailPort,
                secure: true, // Use `true` for port 465, `false` for all other ports
                auth: {
                    user: envConfig_1.default.emailHostUser,
                    pass: envConfig_1.default.emailHostPassword,
                },
            });
            const date = new Date();
            ...
            const mailOptions = {
                from: envConfig_1.default.emailHostUser, // Sender address
            ...
            transporter.sendMail(mailOptions, (error, info) => {
                if (error) {
                    return response.status(500).json({
                        issue: error.message,
                        details: "Unable to send this mail, due to some technical problem. Please try again later.",
                        alert: "If the issue not resolve autometically then contact to your tech support team.",
                    });
                }
                else {
...
exports.default = ContactResponse;
