...
class ResetPasswordLink {
    sendMail(sendTo, userName, corespondingLink, response) {
        ...
        <a href=${corespondingLink}>Here is your reset button</a>
                ...
                transporter.sendMail(mailOptions, (error, info) => {
                    if (error) {
                        return response.status(500).json({
                            issue: error.message,
                            details: "Unable to send this mail due to technical problem, please try again later",
                        });
                    }
                    else {
                ...
                return response.status(500).json({
                    ...
                    message: "Please try again later, or if the issue not resolve autometically then contact with your tech support team.",
                });
            }
        });
    }
