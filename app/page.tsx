...
const AllProjectsDisplayer = dynamic(
  () =>
    import(
      "@/components/single-use/all-projects-displayer/AllProjectsDisplayer"
    ),
  {
...
export const metadata: MetaData = {
  ...
  description:
    "Kunal Chandra Das Magicmind Technology, Kolkata Backoffice employee, Linkdin, Facebook, Instagram Twitter, Github",
  keywords:
    "Web-Developer, MERN-Stack Developer, System Designer, Magicmind Technology, Kolkata, UX-UI Designer, Back office employee, Ignou javascript, react, node js, html, css, bootstrap, tailwind, next js, mongo db mysql kolkata, westbengal, india,",
};
