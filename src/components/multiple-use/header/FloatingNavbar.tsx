...
const FloatingNavbar: React.FC = () => {
  return (
    <nav className="flex justify-center items-center">
      <div
        className="fixed top-0 block mx-auto w-full md:max-w-3xl z-[10001]
        lg:max-w-5xl xl:max-w-[78rem] 2xl:max-w-12xl px-4 py-2
      blurBackground shadow-md rounded-md lg:px-8 lg:py-3 mt-0 md:mt-8"
      >
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          ...
          <div className="hidden lg:block">
           ...
           hover:scale-110 tooltip_bottom_text ${navbarStyle.bottom_tooltip}`}
              >
                <TbFileCv
                  className="text-2xl  text-white font-bold cursor-pointer
             hover:text-orange-500"
                />
                <span className={`${navbarStyle.bottom_tooltip_text} text-xs`}>
                  Download Resume
                </span>
              </li>
              <li
                className={`flex items-center p-1 text-sm gap-x-2 transform 
              translate-1 hover:scale-110 ${navbarStyle.bottom_tooltip}`}
              >
              ...
              <li
                className={`flex items-center p-1 text-sm gap-x-2 transform translate-1
               hover:scale-110 tooltip_bottom_text
