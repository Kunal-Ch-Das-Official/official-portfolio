          ...
          <div className="w-4/5 mx-auto mt-14">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-blue-600 mb-4">
                Client Reviews Management Dashboard
              </h2>
              <p className="text-md font-semibold text-gray-500 mb-12">
                Manage and oversee all client reviews efficiently, and edit or
                            ...
                            >
                              <tr>
                                ...
                                <td className="px-4 py-4 inline-flex">
                                  <Link
                                    title="Edit"
                                    to={`/dashboard/review-edit/${reviews._id}`}
                                  ...
                                  <Link
                                    title="Delete"
                                    to={`/dashboard/review-delete/${reviews._id}`}
                                  ...
                                  <Link
                                    title="View"
                                    to={`/dashboard/review/${reviews._id}`}
