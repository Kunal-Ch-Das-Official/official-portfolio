...
const EditReview = () => {
  ...
  const handleOnSubmit = async (event) => {
    ...
    try {
      ...
      setLoading(false);
      setCustomAlert(true);
      setMessage("Review Has Been Successfully Updated!!");
    } catch (error) {
      console.error(error);
      setLoading(false);
      setCustomAlert(true);
      setMessage("Unable To Update This Review Due To:", error);
    }
  };
  ...
  return (
    <main>
      ...
      {componentMount === true ? (
        ...
        <div className="w-5/6 float-right mb-12">
          <div className="text-center mt-12 ">
            <h2 className="text-3xl font-bold text-blue-600 mb-4">
              Modify Client Review Information
            </h2>
            <p className="text-md font-semibold text-gray-500 mb-12">
              Make changes to your client review information and save updates
            </p>
          </div>
