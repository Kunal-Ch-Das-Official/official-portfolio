  ...
  return (
    <div className="w-5/6 float-right">
      {apiResponse ? (
        <div className="w-4/5 mx-auto mt-14">
          <div className="text-center">
            ...
            <p className="text-md font-semibold text-gray-500 mb-12">
              Thease are the all projects of Kunal Chandra Das you can manage
              all projects from here
            </p>
          </div>
        ...
        <h1 className="text-center my-auto text-3xl font-bold pl-36 text-gray-500 ">
          No projects found please upload a projects first 404
        </h1>
      )}
    </div>
  );
