...
const EditProject = () => {
  ...
  const handleOnSubmit = async (event) => {
    ...
    try {
      ...
      console.log(error);
      setLoadingState(false);
      setMessage("Unable To Update This Project Due To:", error);
      setCustomAlert(true);
    }
            ...
            <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
              ...
              <div className="mb-10 md:mb-16">
                ...
                <p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">
                  Ensure all project details are accurate and up-to-date if it
                  is! then save to update
                </p>
              </div>
                ...
                <div className="sm:col-span-2">
                  <div className="font-[sans-serif] max-w-md">
                    ...
                    <input
                      ...
                      id="firstView"
                      onChange={(event) =>
                        setFirstPageImg(event.target.files[0])
                      }
                      className="w-full text-gray-400 font-semibold text-sm bg-white border file:cursor-pointer cursor-pointer file:border-0 file:py-3 file:px-4 file:mr-4 file:bg-blue-100 file:hover:bg-blue-200 file:text-gray-500 rounded"
                    />
                    <p className="text-xs text-gray-400 mt-2">
                ...
                <div className="sm:col-span-2">
                  <div className="font-[sans-serif] max-w-md">
                    ...
                    <input
                      ...
                      id="secondView"
                      onChange={(event) =>
                        setSecondPageImg(event.target.files[0])
                      }
                      className="w-full text-gray-400 font-semibold text-sm bg-white border file:cursor-pointer cursor-pointer file:border-0 file:py-3 file:px-4 file:mr-4 file:bg-blue-100 file:hover:bg-blue-200 file:text-gray-500 rounded"
                    />
                    <p className="text-xs text-gray-400 mt-2">
                ...
                <div className="sm:col-span-2">
                  <div className="font-[sans-serif] max-w-md">
                    ...
                    <input
                      ...
                      id="thirdView"
                      onChange={(event) =>
                        setThirdPageImg(event.target.files[0])
                      }
                      className="w-full text-gray-400 font-semibold text-sm bg-white border file:cursor-pointer cursor-pointer file:border-0 file:py-3 file:px-4 file:mr-4 file:bg-blue-100 file:hover:bg-blue-200 file:text-gray-500 rounded"
                    />
                    <p className="text-xs text-gray-400 mt-2">
