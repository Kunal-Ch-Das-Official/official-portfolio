...
const ManageBlogs = () => {
  ...
  useEffect(() => {
    ...
    const getAllreviews = async () => {
      ...
      try {
        await axios.get(envConfig.getAllBlogApiUrl)
        .then((res) => {
                  ...
                  <table className="min-w-full divide-y divide-gray-200 ">
                    <thead className="bg-gray-50">
                      <tr>
                        ...
                        <th scope="col" className="relative py-3.5 pr-8 text-gray-800">
                        ...
                        <th scope="col" className="relative py-3.5 pr-32 text-gray-800">
                        Publisher 
                        </th>
                    ...
                    </thead>
                     {
                      apiResponse.map((blog) => 
                        <tbody className="bg-white divide-y divide-gray-200" key={blog._id}>
                      <tr>
                        ...
                        <td className="px-12 py-4 text-md font-semibold">
                        ...
                        <td className="px-4 py-4 inline-flex">
                          ...
                          <Link to={`/dashboard/blog-delete/${blog._id}`}
                            className="px-2 mx-4 py-1 rounded-lg hover:bg-black transition-colors duration-200">
                             ...
                             <Link to={`/dashboard/blog-overview/${blog._id}`} className="px-2 py-1 transition-colors duration-200 rounded-lg 
                              hover:bg-black">
