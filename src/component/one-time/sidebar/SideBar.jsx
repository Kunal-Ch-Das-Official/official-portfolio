...
const SideBar = () => {
  ...
  return (
    <div>
      <nav className="bg-white shadow-lg h-screen fixed top-0 left-0 min-w-[220px] py-6 px-6 font-[sans-serif] flex flex-col overflow-auto">
        <div className="flex flex-wrap items-center cursor-pointer">
          ...
          <div className="ml-4">
            <p className="text-sm text-[#3949ab] font-semibold">
              Kunal Chandra Das
            </p>
        ...
        <ul className="space-y-8 pl-3 flex-1 mt-10">
          ...
          <li>
            <Link
              to={"/dashboard"}
              className="text-[#3949ab] font-semibold text-sm flex items-center rounded-md left-0 hover:left-1 relative transition-all"
            >
          ...
          <ol className="cursor-pointer">
            ...
            <div
              className={`${
                showProjects === true ? "flex" : "hidden"
              } flex-col cursor-pointer font-semibold text-sm my-2 text-[#3949ab]
          shadow-xl py-2 `}
            >
              <Link
                to={"/dashboard/project-manage"}
                className="mb-2 inline-flex items-center p-2"
              >
          ...
          <ol className="cursor-pointer">
            ...
            <div
              className={`${
                showResume === true ? "flex" : "hidden"
              } flex-col font-semibold text-sm my-2 text-[#3949ab]
