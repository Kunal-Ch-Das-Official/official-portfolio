...
const CustomAlert = ({buttonText, showOrHide, closeButton, statusIcon, alertHead, message1, message2, buttonColor }) => {
    ...
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="mt-8">
        ...
        <button onClick={closeButton}
          className={`px-6 py-2.5 mt-8 w-full rounded text-white text-sm font-semibold border-none outline-none ${buttonColor}`}>{buttonText}</button>
      </div>
    </div>
  </div>
  );
