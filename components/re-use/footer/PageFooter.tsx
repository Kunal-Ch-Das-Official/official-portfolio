    ...
    <footer className="mt-12">
       <div className="new_footer_area bg_color">
            <div className="new_footer_top">
                <div className="footer_bg w-screen">
                  <div className="vc_bg">
      ...
      <div className="footer border-t-4 border-gray-50 flex flex-col md:justify-around md:flex-row h-full md:h-24 bannerBackground text-neutral-content items-center p-4 pb-6 lg:pb-0">
        ...
        <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
          <a
            ...
            aria-label="github"
            rel="noopener"
            className="ring-1 ring-orange-500 rounded-full px-2 py-2"
          >
