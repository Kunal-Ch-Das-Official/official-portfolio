...
function LeftImageHero() {
  ...
  return (
    <main>
      <div className="hidden md:hidden sm:hidden lg:mx-[400px] xl:mx-[500px] 2xl-[mx-1200px] lg:flex justify-center items-center border-2 border-orange-500 h-12 rounded-md"></div>

      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-0 ">
        <div className="h-full border-r-0 lg:border-r-8 lg:border-orange-500 py-0 lg:py-24">
          <span
        ...
        <div className="h-full py-0 lg:py-24 flex flex-wrap flex-col">
