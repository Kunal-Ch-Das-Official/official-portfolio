...
const MyStack = () => {
  ...
  <div className="relative mb-12 px-3 lg:mb-0">
    ...
    <h6 className="mb-0 font-normal dark:text-neutral-50 text-center">60%</h6>
    <div
  ...
  <div className="relative mb-12 px-3 lg:mb-0">
    ...
    <h5 className="mb-3 font-bold text-primary text-center">Express JS</h5>
    <h6 className="mb-0 font-normal dark:text-neutral-50 text-center">70%</h6>
    <div
      className="absolute right-0 top-0 hidden h-full min-h-[1em] w-px self-stretch border-t-0 bg-gradient-to-tr from-transparent via-neutral-500 to-transparent opacity-25 dark:via-neutral-400 lg:block"></div>
  </div>
  <div className="relative mb-12 px-3 lg:mb-0">
    ...
    <h6 className="mb-0 font-normal dark:text-neutral-50 text-center">95%</h6>
    <div
      className="absolute right-0 top-0 hidden h-full min-h-[1em] w-px self-stretch border-t-0 bg-gradient-to-tr from-transparent via-neutral-500 to-transparent opacity-25 dark:via-neutral-400 lg:block"></div>
  </div>
  <div className="relative mb-12 px-3 lg:mb-0">
    ...
    <h6 className="mb-0 font-normal dark:text-neutral-50 text-center">80%</h6>
  </div>
</div>
    </div>
  )
