    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2 h-[25rem] flex justify-start items-start  rounded-2xl  group-hover/pin:boxShadow blurBackgroundItem border border-white/[0.1] group-hover/pin:border-orange-300 transition duration-700 overflow-hidden"
        >
          <div className={aceternityConfig(" relative z-50 ", className)}>
            {children}
          </div>
        </div>
      </div>
